...
INSERT INTO trip (tour_name, description, start_date, end_date, price, max_participants, guide_name, difficulty_level, pickup_location) VALUES
...
INSERT INTO trip_orders (tourist_id, trip_id) VALUES
(1, 5), (1, 3), (2, 1), (2, 4), (3, 6), (3, 12),
(3, 8), (3, 9), (7, 7), (7,4), (7, 10), (18, 1),
(27, 11);  --And so on.. 


INSERT INTO trip_orders (tourist_id, trip_id)
SELECT id, tour_id
FROM tourists
WHERE tour_id IS NOT NULL;


ALTER TABLE tourists DROP COLUMN tour_id;


--Q2

CREATE OR REPLACE PROCEDURE total_revenue_year( year_choice INT, OUT total_revenue NUMERIC)
LANGUAGE plpgsql AS 
$$
BEGIN
    ...
    FROM movies
    WHERE year = year_choice;
END;
$$;

CALL total_revenue_year(2022);
